            ...
            <AnimatePresence mode='popLayout'>
              ...
              {activeTasks.map((task, index) => (
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col justify-center min-w-0 pr-2 md:pr-4">
                    {editingId === task.id ? (
                      <div className="flex items-center gap-3 w-full">
                        ...
                        />
                        <button onClick={saveEdit} className="p-2 bg-emerald-500 text-white rounded-xl shadow-lg"><Check size={18} /></button>
                      </div>
                    ) : (
                  ...
                  <div className="flex items-center gap-1 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all scale-100 md:scale-95 md:group-hover:scale-100">
                     <button 
