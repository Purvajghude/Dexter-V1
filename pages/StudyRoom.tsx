...
const StudyRoom: React.FC<StudyRoomProps> = ({ isDarkMode, theme }) => {
  ...
  return (
    <div ref={containerRef} className={`relative h-full flex flex-col overflow-hidden transition-all duration-1000 ${isFullscreen ? 'bg-black' : 'bg-gradient-to-br from-[#1a2e29] via-[#0f172a] to-[#000000]'}`}>
          ...
          >
            <div>
              ...
              >
                 ...
                 <span className="text-[10px] font-black uppercase tracking-[0.3em] text-emerald-100/60 drop-shadow-md">Sector 7 Sanctuary</span>
              </motion.div>
        ...
        >
           ...
           <div className={`absolute top-0 left-0 right-0 p-6 md:p-10 flex justify-between items-start opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-30`}>
              <div className="flex flex-col text-white">
                 ...
                 <p className="text-xs text-emerald-300 font-bold uppercase tracking-widest drop-shadow-md mt-1">{STREAMS[currentStreamIdx].label}</p>
              </div>
           ...
           {/* --- AMBIENT MIXER (Floating Control Deck) --- */}
           <div className={`absolute bottom-0 left-1/2 -translate-x-1/2 mb-6 md:mb-12 w-[90%] md:w-auto max-w-3xl z-30 transition-all duration-700 transform
           ...
           `}>
              ...
              `}>
                 ...
                 <div className="w-full md:w-auto flex items-center justify-between gap-1 px-4 py-2 md:py-0 overflow-x-auto no-scrollbar">
                    {AMBIENT_SOUNDS.map(sound => (
                       <div key={sound.id} className="relative flex flex-col items-center group/sound py-2">
                          ...
                          <button 
                             ...
                             className={`
                               p-4 rounded-2xl transition-all duration-300 relative group-hover/sound:scale-110
                               ${volumes[sound.id] > 0 
